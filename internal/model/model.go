...
type User struct {
	...
	// 虚拟字段，不映射到数据库
	BankCount int64 `gorm:"-" json:"bankCount"`
}
...
type WrongQuestion struct {
	ID         int64     `gorm:"primaryKey;autoIncrement" json:"id"`
	UserID     int64     `gorm:"uniqueIndex:idx_user_question;not null" json:"user_id"`
	QuestionID int64     `gorm:"uniqueIndex:idx_user_question;not null" json:"question_id"`
